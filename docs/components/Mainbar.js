        ...
        <Container>
          ...
          <ul className='nav-menu-items'>
            ...
            <Div rounded="md" className="my_tag" p="0.75rem">
              <Row>
                <Col size="4"> <img className="dp" src="../image/dp.jpg" />
                </Col>
                <Col size="8">
                  <Text textWeight="600" textColor="white">John Viannie Wasswa</Text>
                  <Text textSize="caption" textWeight="300" textColor="white">User</Text>
                </Col>
              </Row>
            </Div>
            <Div className="nav-text" m={{ t: "3rem", l: "2rem" }}>
              <Link to="/"><Text textWeight="500" textColor="#252859">DASHBOARD</Text></Link>
              <li>
                <Link to="/Goal">
                ...
                <Link to="/">
                  <Div p={{ y: "0.25rem" }} m={{ t: "1rem", }} className="listings">
                    <Iconly
                      ...
                      secondaryColor='orange'
                      stroke='bold'
                    /> <Text textColor={`#808080`} textWeight="500" m={{ l: "0.7rem", }}>Help</Text>
                  </Div>
                </Link>
